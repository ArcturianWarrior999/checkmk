...
import codeExample from './UclSwitchCellCodeExample.vue?raw'
...
export const panelConfig = {
  value: {
    ...
    title: 'value',
    initialState: false,
    help: 'The on/off state of the switch. Bound via v-model.'
  },
  justify: {
    type: 'list' as const,
    title: 'justify',
...
<template>
  <UclDetailPageLayout>
    <UclDetailPageHeader>SwitchCell</UclDetailPageHeader>

    <UclDetailPageComponent>
      <div class="ucl-switch-cell__table-wrap">
        <MonitoringTable
          :rows="rows"
          :fetch-state="'idle'"
          :has-loaded="true"
...
.ucl-switch-cell__table-wrap :deep(.monitoring-table__table) {
  width: auto;
}
</style>
