...
import codeExample from './UclColorPickerCellCodeExample.vue?raw'
...
export const panelConfig = {
  color: {
    ...
    title: 'value',
    initialState: '#3c85f2',
    help: 'The hex color rendered in the swatch. Two-way bound via v-model — editing the swatch updates this field and vice versa.'
  },
  justify: {
    type: 'list' as const,
    title: 'justify',
...
<template>
  <UclDetailPageLayout>
    <UclDetailPageHeader>ColorPickerCell</UclDetailPageHeader>

    <UclDetailPageComponent>
      <div class="ucl-color-picker-cell__table-wrap">
        <MonitoringTable
          :rows="rows"
          :fetch-state="'idle'"
          :has-loaded="true"
...
<style scoped>
.ucl-color-picker-cell__table-wrap {
  width: 100%;
}
...
.ucl-color-picker-cell__table-wrap :deep(.monitoring-table__table) {
  width: auto;
}
</style>
